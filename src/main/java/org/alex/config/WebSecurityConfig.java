...
import org.alex.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/hello").access("hasRole('ROLE_USER')").anyRequest().permitAll().and()
				...
				.logoutSuccessUrl("/login?logout").logoutSuccessUrl("/hello").
